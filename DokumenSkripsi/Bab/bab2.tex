...
\begin{figure}[H]
    \centering  
    \includegraphics[scale=0.6]{codis}  
    \caption[Perpotongan \textit{dendrogram} ]{Perpotongan \textit{dendrogram}} 
    \label{fig:codis} 
\end{figure}

Dari setiap \textit{cluster} yang hidasilkan dari perpotongan, perlu dicari nilai minimum, maksimum, rata-rata, dan standar deviasi dari setiap atribut. Nilai-nilai ini dapat disebut pola. Pola ini akan merepresentasikan dan menggambarkan karakteristik \textit{cluster} tersebut. Pola ini akan disimpan sebagai hasil akhir untuk menggantikan data mentahnya. 
