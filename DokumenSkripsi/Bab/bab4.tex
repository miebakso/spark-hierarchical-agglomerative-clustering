...
\begin{algorithm}[H]
	...
	\Begin{
		...
		\ForEach{line pada \textbf{\textit{A}}}{
			...
			\randomKey{hasilkan bilangan acak}
...
\item \textit{mapData}: \textit{method} untuk mengubah baris-baris attribut bertipe \textit{String} menjadi objek \it{Node}. Setiap \it{Node} akan dipasangkan dengan \it{key} yaitu sebuah bilangan acak. \textit{Method} ini akan mengembalikan RDD bertipe <\it{key},\it{Node}>.  
