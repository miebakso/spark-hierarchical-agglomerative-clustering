...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 5 GB, Objek Maksimum 100, dan Toal 10 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 5 GB, Objek Maksimum 100, dan Toal 10 Core}
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 10 GB, Objek Maksimum 100, dan Toal 10 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 10 GB, Objek Maksimum 100, dan Toal 10 Core}
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 15 GB, Objek Maksimum 100, dan Toal 10 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 15 GB, Objek Maksimum 100, dan Toal 10 Core}
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 20 GB, Objek Maksimum 100, dan Toal 10 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 20 GB, Objek Maksimum 100, dan Toal 10 Core}
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (300,281) (400,252) (500,241) (600,244) (700,229)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (300,294) (400,263) (500,232) (600,231) (700,220)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,337) (30,461) (50,530) (100,612) (200,830) };
		

		\leg
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 5 GB, Objek Maksimum 30, dan Total 30 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 5 GB, Objek Maksimum 30, dan Total 30 Core}
...
Berdasarkan hasil grafik (~\ref{fig:percobaan911}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop.  \\
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (500,421) (700,395) (900,383) (1100,361) (1300,343)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (500,404) (700,389) (900,392) (1100,359) (1300,343)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,621) (30,854) (50,937) (100,1076) (200,1385) };
		

		\leg
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 10 GB, Objek Maksimum 30, dan Total 30 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 10 GB, Objek Maksimum 30, dan Total 30 Core}
...
Berdasarkan hasil grafik (~\ref{fig:percobaan1011}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop.  \\
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (900,601) (1200,562) (1500,515) (1800,472) (2100,442)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (900,596) (1200,569) (1500,527) (1800,483) (2100,435)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,981) (30,1286) (50,1631) (100,1661) (200,2125) };
		...
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 15 GB, Objek Maksimum 30, dan Total 30 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 15 GB, Objek Maksimum 30, dan Total 30 Core}
...
Berdasarkan hasil grafik (~\ref{fig:percobaan1111}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop. \\
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (1000,780) (1400,723) (1800,613) (2000,553) (2600,530)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (1000,782) (1400,720) (1800,631) (2000,557) (2600,535)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,1662) (30,1936) (50,2539) (100,3153) (200,4145) };
		

		\leg
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 20 GB, Objek Maksimum 30, dan Total 30 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 20 GB, Objek Maksimum 30, dan Total 30 Core}
...
Berdasarkan hasil grafik (~\ref{fig:percobaan1211}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop. \\
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (300,238) (400,207) (500,189) (600,185) (700,177)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (300,246) (400,217) (500,195) (600,182) (700,178)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,206) (30,234) (50,252) (100,270) (200,305) };
		

		\leg
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 5 GB, Objek Maksimum 30, dan Total 50 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 5 GB, Objek Maksimum 30, dan Total 50 Core}
...
Berdasarkan hasil grafik (~\ref{fig:percobaan9115}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop.  \\
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (500,304) (700,278) (900,251) (1100,228) (1300,205)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (500,312) (700,296) (900,261) (1100,226) (1300,197)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,331) (30,350) (50,384) (100,428) (200,453) };
		

		\leg
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 10 GB, Objek Maksimum 30, dan Total 50 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 10 GB, Objek Maksimum 30, dan Total 50 Core}
...
Berdasarkan hasil grafik (~\ref{fig:percobaan10115}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop.  \\
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (900,571) (1200,507) (1500,439) (1800,392) (2100,331)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (900,543) (1200,525) (1500,460) (1800,412) (2100,315)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,556) (30,613) (50,685) (100,732) (200,779) };
...
Berdasarkan hasil grafik (~\ref{fig:percobaan11115}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop. \\
...
\begin{minipage}[c]{0.9\textwidth}
	\begin{figure}[H]
		...
		\addlegendentry{Spark tanpa standar Deviasi}
		\addplot+[smooth][color=black,mark=triangle] coordinates { (1000,601) (1400,516) (1800,436) (2000,395) (2600,301)};
		\addlegendentry{Spark dengan standar Deviasi}
		\addplot+[smooth][color=red] coordinates { (1000,596) (1400,524) (1800,452) (2000,407) (2600,310)};
		\addlegendentry{Hadoop}
		\addplot+[smooth][color=blue] coordinates {(10,715) (30,827) (50,1134) (100,1274) (200,1421) };
		...
		\end{axis}
		\end{tikzpicture}
		\caption[Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 20 GB, Objek Maksimum 30, dan Total 50 Core]{Hasil Percobaan Jumlah Partisi Spark dan Hadoop dengan Ukuran Data 20 GB, Objek Maksimum 30, dan Total 50 Core}
...
Berdasarkan hasil grafik (~\ref{fig:percobaan12115}), dapat dilihat waktu Hadoop terus meningkat seiring meningkatnya jumlah partisi. Jumlah partisi yang dicoba pada Hadoop hanya mencapai 200 karena waktu eksekusi yang sudah berbeda jauh dibanding Spark dan untuk partisi yang lebih besar pasti diatas waktu eksekusi Hadoop dengan jumlah partisi sama dengan 200. Spark memiliki waktu eksekusi yang jauh lebih cepat dibanding Hadoop. 
